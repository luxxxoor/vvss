...
public class IntegrationTest_TopDown {
    ...
    @Test
    public void integrationTest_TopDown_A() throws DuplicateIntrebareException, InputValidationFailedException {
        // test Add Intrebare
        appController.addNewIntrebare(new Intrebare("Enunt 1?", "1) Varianta 1", "2) Varianta 2", "3) Varianta 3", "1", "Mate"), fileName);
    ...
    @Test
    public void integrationTest_TopDown_AB() throws DuplicateIntrebareException, InputValidationFailedException {
        // test Add Intrebare
        appController.addNewIntrebare(new Intrebare("Enunt 1?", "1) Varianta 1", "2) Varianta 2", "3) Varianta 3", "1", "Mate"), fileName);
        appController.addNewIntrebare(new Intrebare("Enunt 2?", "1) Varianta 1", "2) Varianta 2", "3) Varianta 3", "1", "Romana"), fileName);
        appController.addNewIntrebare(new Intrebare("Enunt 3?", "1) Varianta 1", "2) Varianta 2", "3) Varianta 3", "1", "Info"), fileName);
    ...
    @Test
    public void integrationTest_TopDown_ABC() throws DuplicateIntrebareException, InputValidationFailedException {
        // test Add Intrebare
        appController.addNewIntrebare(new Intrebare("Enunt 1?", "1) Varianta 1", "2) Varianta 2", "3) Varianta 3", "1", "Mate"), fileName);
        appController.addNewIntrebare(new Intrebare("Enunt 2?", "1) Varianta 1", "2) Varianta 2", "3) Varianta 3", "1", "Romana"), fileName);
        appController.addNewIntrebare(new Intrebare("Enunt 3?", "1) Varianta 1", "2) Varianta 2", "3) Varianta 3", "1", "Info"), fileName);
